    ...
    <>
      <div className="col-lg-8 col-xl-7">
        <div className="about_content">
          <p className="large">
            At Rayna Properties, we&apos;ve proudly stand as one of the leading and most reliable property experts in the United Arab Emirates (UAE). With a deep-rooted commitment to excellence, we have established ourselves as a trusted name in the realm of real estate, offering unparalleled property services to meet the dynamic needs of our diverse clientele.
          </p>
          <p>
